...
Future<void> main() async {
  // Ensure that Flutter bindings are initialized before any asynchronous work
  WidgetsFlutterBinding.ensureInitialized();

  // Load environment variables from the .env file (if you're using them)
  await dotenv.load(fileName: 'assets/.env');
  print('Dotenv loaded successfully: ${dotenv.isEveryDefined(['1:219551804012:ios:26f468df117c8307ebc649'])}');
...
class MainScreenState extends State<MainScreen> {
  ...
  // List of screens used for bottom navigation
